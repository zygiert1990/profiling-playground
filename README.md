...
2. Attach `jhsdb` command line debugger to running JVM: `jhsdb clhsdb --pid 22784`
...
Symbol* Klass::_name: Symbol @ 0x00007f52840ed948
...
ClassLoaderData* Klass::_class_loader_data: ClassLoaderData @ 0x00007f52840dfc60
ObjArrayKlass* InstanceKlass::_array_klasses: ObjArrayKlass @ null
Array<Method*>* InstanceKlass::_methods: Array<Method*> @ 0x00007f5254400348
...
Array<u1>* InstanceKlass::_fieldinfo_stream: Array<u1> @ 0x00007f5254400650
ConstantPool* InstanceKlass::_constants: ConstantPool @ 0x00007f5254400058
char* InstanceKlass::_source_debug_extension: char @ null
Array<jushort>* InstanceKlass::_inner_classes: Array<jushort> @ 0x00007f5254400638
...
jmethodID* InstanceKlass::_methods_jmethod_ids: jmethodID @ 0x00007f5284102220
...
```
5. Inspect methods metadata pointers: `mem 0x00007f5254400348/4` (since I know that there are 3 methods):
```
0x00007f5254400348: 0x0000000000000003
0x00007f5254400350: 0x00007f52544003b8
0x00007f5254400358: 0x00007f52544004d8
0x00007f5254400360: 0x00007f52544005b0
```
6. Inspect specific method metadata: `inspect 0x00007f52544003b8`:
```
Type is Method (size of 88)
ConstMethod* Method::_constMethod: ConstMethod @ 0x00007f5254400410
MethodData* Method::_method_data: MethodData @ null
MethodCounters* Method::_method_counters: MethodCounters @ 0x00007f5254400778
AccessFlags Method::_access_flags: 8
int Method::_vtable_index: -2
u2 Method::_intrinsic_id: 0
nmethod* Method::_code: nmethod @ null
address Method::_i2i_entry: address @ 0x00007f5254400510
address Method::_from_compiled_entry: address @ 0x00007f5254400518
address Method::_from_interpreted_entry: address @ 0x00007f5254400528
```
7. Inspect method counters: `inspect 0x00007f5254400778`:
```
...
InvocationCounter MethodCounters::_backedge_counter: 178
```
8. Inspect method data: `inspect 0x00007f52544007f8`:
```
Type is MethodData (size of 216)
int MethodData::_size: 280
Method* MethodData::_method: Method @ 0x00007f52544005b0
...
```
9. Disassemble machine code: `disassemble 0x00007f526c427288` - for this `hsdis` binary is required. Can be either
