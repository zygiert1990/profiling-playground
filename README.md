...
1. Build project with `mvn clean install` and run with: `java -XX:+PrintCompilation -jar target/app.jar 100000 100`
...
```
org/zygiert/Main @0x0000000029040000
```
4. Inspect class metadata details: `inspect 0x0000000029040000`:
```
Type is InstanceKlass (size of 472)
juint Klass::_super_check_offset: 56
Klass* Klass::_secondary_super_cache: Klass @ null
Array<Klass*>* Klass::_secondary_supers: Array<Klass*> @ 0x00000000286783c0
Klass* Klass::_primary_supers[0]: Klass @ 0x0000000028171bf8
OopHandle Klass::_java_mirror: OopHandle @ 0x0000000029040070
Klass* Klass::_super: Klass @ 0x0000000028171bf8
Klass* Klass::_subklass: Klass @ null
jint Klass::_layout_helper: 16
Symbol* Klass::_name: Symbol @ 0x00007f30b40edd88
AccessFlags Klass::_access_flags: 33
Klass* Klass::_next_sibling: Klass @ 0x000000002824ef70
Klass* Klass::_next_link: Klass @ null
int Klass::_vtable_len: 5
ClassLoaderData* Klass::_class_loader_data: ClassLoaderData @ 0x00007f30b40dfca0
...
Array<InstanceKlass*>* InstanceKlass::_local_interfaces: Array<InstanceKlass*> @ 0x00000000286783d8
Array<InstanceKlass*>* InstanceKlass::_transitive_interfaces: Array<InstanceKlass*> @ 0x00000000286783d8
Array<u1>* InstanceKlass::_fieldinfo_stream: Array<u1> @ 0x00007f307c400818
ConstantPool* InstanceKlass::_constants: ConstantPool @ 0x00007f307c400068
char* InstanceKlass::_source_debug_extension: char @ null
Array<jushort>* InstanceKlass::_inner_classes: Array<jushort> @ 0x00007f307c4007f0
Array<jushort>* InstanceKlass::_nest_members: Array<jushort> @ 0x00007f307c400810
...
jmethodID* InstanceKlass::_methods_jmethod_ids: jmethodID @ 0x00007f30b4102660
u2 InstanceKlass::_idnum_allocated_count: 4
Annotations* InstanceKlass::_annotations: Annotations @ null
Array<int>* InstanceKlass::_method_ordering: Array<int> @ 0x00000000286f8e30
Array<int>* InstanceKlass::_default_vtable_indices: Array<int> @ null
```
5. Inspect methods metadata pointers: `mem 0x00007f307c400400/5` (since I know that there are 4 methods):
```
...
```
6. Inspect specific method metadata: `inspect 0x00007f307c400768`:
```
Type is Method (size of 88)
ConstMethod* Method::_constMethod: ConstMethod @ 0x00007f307c400700
MethodData* Method::_method_data: MethodData @ 0x00007f307c401800
MethodCounters* Method::_method_counters: MethodCounters @ 0x00007f307c400f48
AccessFlags Method::_access_flags: 10
int Method::_vtable_index: -2
u2 Method::_intrinsic_id: 0
nmethod* Method::_code: nmethod @ 0x00007f309c425788
address Method::_i2i_entry: address @ 0x00007f307c4007a0
address Method::_from_compiled_entry: address @ 0x00007f307c4007a8
address Method::_from_interpreted_entry: address @ 0x00007f307c4007b8
```
7. Inspect method counters: `inspect 0x00007f307c400f48`:
```
...
```
8. Inspect method data: `inspect 0x00007f307c401800`:
```
Type is MethodData (size of 216)
int MethodData::_size: 296
Method* MethodData::_method: Method @ 0x00007f307c400768
...
```
9. Disassemble machine code: `disassemble 0x00007f309c425788` - for this `hsdis` binary is required. Can be either
